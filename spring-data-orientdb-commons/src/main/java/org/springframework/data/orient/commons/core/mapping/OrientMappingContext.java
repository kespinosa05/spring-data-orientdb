...
/**
 * Default implementation of a {@link MappingContext} for MongoDB using {@link BasicOrientPersistentEntity} and
 * {@link BasicOrientPersistentProperty} as primary abstractions.
 *
 * @author Jon Brisbin
...
public class OrientMappingContext extends AbstractMappingContext<BasicOrientPersistentEntity<?>, OrientPersistentProperty>
	...
	/**
	 * Creates a new {@link OrientMappingContext}.
	 */
	public OrientMappingContext() {
		setSimpleTypeHolder(OrientSimpleTypes.HOLDER);
	}
	...
	protected boolean shouldCreatePersistentEntityFor(TypeInformation<?> type) {
		return !OrientSimpleTypes.HOLDER.isSimpleType(type.getType()) && !AbstractMap.class.isAssignableFrom(type.getType());
	}
	 ...
	 */
	@Override
	public OrientPersistentProperty createPersistentProperty(Property property, BasicOrientPersistentEntity<?> owner,
			SimpleTypeHolder simpleTypeHolder) {
		return new CachingOrientPersistentProperty(property, owner, simpleTypeHolder, fieldNamingStrategy);
	}
	 ...
	 */
	@Override
	protected <T> BasicOrientPersistentEntity<T> createPersistentEntity(TypeInformation<T> typeInformation) {
		return new BasicOrientPersistentEntity<T>(typeInformation);
	}
